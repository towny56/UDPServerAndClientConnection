...
/**
 * An implementation of the Opus-Miner algorithm proposed in : </br></br>
 * 
 ...
 *  
 *  =========================================
 *  This is the header of the C++ code:
 *  
 *  OPUS Miner: Filtered Top-k Association Discovery of Self-Sufficient Itemsets
 *  Version 1.2.1
 *  Copyright (C) 2012-2016 Geoffrey I WebbThis program comes with ABSOLUTELY NO WARRANTY. 
...
public class AlgoOpusMiner {
	...
	public void runAlgorithm(String inputFileName, String outputFileName,
			boolean printClosure, boolean filter, int k, boolean searchByLift,
			boolean correctionForMultiCompare, boolean redundancyTests,
			boolean isCSVInputFile) throws IOException {
		...
		while (!itemsets.isEmpty())
		{
		  ...
		  itemsets.poll();
			...
			PrintItemsets.print_itemsets(writer, is, isCSVInputFile);
			MemoryLogger.getInstance().checkMemory();
	...
	public void printStats() {
		System.out.println("=============  Opus-Miner algorithm v2.35 - STATS =======");
		System.out.println(" Non-redundant productive itemset count: " + nonRedundantProductiveItemsetsCount);
